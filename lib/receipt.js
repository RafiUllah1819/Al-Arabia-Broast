...
.rct-item .cn .var { display: block; font-size: 10.5px; color: #000; margin-top: 1px; }
.rct-item .cq { color: #000; font-size: 11.5px; padding-top: 1px; }
.rct-item .cr { color: #000; font-size: 11.5px; padding-top: 1px; }
...
/* ── Footer ── */
.rct-footer-msg  { text-align: center; font-size: 11px; color: #000; margin-bottom: 3px; }
.rct-footer-phone { text-align: center; font-size: 11px; color: #000; margin-top: 2px; }
  `.trim();
}
