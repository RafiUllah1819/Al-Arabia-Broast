...
.rct-item .cn .var { display: block; font-size: 9.5px; color: #000; margin-top: 1px; }
.rct-item .cq { color: #000; font-size: 10.5px; padding-top: 1px; }
.rct-item .cr { color: #000; font-size: 10.5px; padding-top: 1px; }
...
.rct-footer-phone { text-align: center; font-size: 10px; color: #000; margin-top: 2px; }
  `.trim();
}
