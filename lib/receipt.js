...
/* ── Receipt wrapper ── */
.rct-wrap {
  width: 264px;                           /* 80mm at 96dpi minus margins */
  background: white;
...
.sep-solid { border: none; border-top: 1px solid #333;  margin: 5px 0; }
...
.rct-row .lbl { color: #777; min-width: 54px; flex-shrink: 0; }
...
.cr  { width: 48px; text-align: right; }
.ct  { width: 54px; text-align: right; padding-left: 6px; }

.rct-item { display: flex; align-items: flex-start; font-size: 11px; margin-bottom: 5px; }
.rct-item .cn { line-height: 1.3; padding-right: 4px; }
.rct-item .cn .var { display: block; font-size: 9.5px; color: #888; margin-top: 1px; }
.rct-item .cq { color: #555; font-size: 10.5px; padding-top: 1px; }
.rct-item .cr { color: #666; font-size: 10.5px; padding-top: 1px; }
.rct-item .ct { font-weight: bold; font-size: 11px; }
...
/* ── Footer ── */
.rct-footer-msg  { text-align: center; font-size: 11px; color: #333; margin-bottom: 3px; }
.rct-footer-phone { text-align: center; font-size: 10px; color: #777; margin-top: 2px; }
  `.trim();
}
...
<div class="rct-item">
  ...
  <span class="ct">${sym}${lineTotal}</span>
...
<div class="rct-wrap">
  ...
  ${row("Date",     fmtReceiptDate(order.created_at))}
  ${row("Time",     fmtReceiptTime(order.created_at))}
  ${row("Type",     typeLabel)}
  ...
  <div class="rct-items-hdr">
    ...
    <span class="cr">Rate</span><span class="ct">Total</span>
  </div>

  ${itemsBlock}

  <div class="sep-solid"></div>
  <div class="rct-subtotal"><span>Subtotal</span><span>${sym}${subtotal.toFixed(2)}</span></div>
