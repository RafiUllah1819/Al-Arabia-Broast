...
/* ── Developer credit ── */
.rct-dev-credit { text-align: center; font-size: 11px; color: #000; margin-top: 10px; border-top: 1px dashed #bbb; padding-top: 6px; }
  `.trim();
}
...
<div class="rct-wrap">
  ...
  <div class="rct-dev-credit">Designed &amp; Developed by Rafi<br>+923469994131</div>
</div>`.trim();
}
